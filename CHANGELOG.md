...
- New private "review your details" page for speakers, so each presenter can preview and sign off on their info before the agenda goes live. Started with Dr. Harold Katz as the format sample. Each page shows a warm thank-you note, then their agenda slot, their speaker card, and their full bio/detail exactly as visitors will see them. The page is hidden from search engines and only reachable by its direct link (e.g. dentalwisdom.org/speaker-review/dr-harold-katz).
