...
- Agenda: the Wednesday opening event is renamed "Opening Night: Casino, Cigars & Scotch," with a fun line beneath it — "Grab your ID badge, a drink, and a stack of chips — then hit the tables, light up a cigar, and kick off the weekend in style. The night's biggest winner takes home a grand prize worth $2,000+." It's now credited as sponsored by MB Precious Metals. (This is on the draft/full Agenda page, which isn't live to visitors yet.)
