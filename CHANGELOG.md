...
- Agenda: the fourth Friday 3:00–5:00 PM hands-on track is now "Complications in Perio Anterior Cases," sponsored by Adin (speaker still to be announced). The implants track — which previously carried the Adin sponsorship — now reads "Topic to Be Announced Soon" with no sponsor. The other two tracks stay ortho (Dr. Sam Glick) and cosmetic (Dr. Elaine Bylis). All four tracks carry 2 CE credits.
