...
- Added a new Dental Wisdom Live session: "Effortless AI in Pediatric Dentistry" with Dr. Josh Solomon, August 27, 2026 at 8:00 PM EST, sponsored by Pearl. The description notes that all attendees get a free month of Pearl and must register to receive the CE credits and free month. Registration link added, so the Sign Up button is now live
