...
- Agenda: the Wednesday opening event is renamed "Opening Night: Casino, Cigars & Scotch," with a fun line beneath it — "Registration & check-in open. Try your luck at the tables, light up a cigar, pour a scotch, and kick off the weekend in style." It's now credited as sponsored by MB Precious Metals. (This is on the draft/full Agenda page, which isn't live to visitors yet.)
