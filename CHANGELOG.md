...
- Agenda: the Wednesday opening event is renamed "Opening Night: Casino, Cigars & Scotch," with a short line beneath it — "Registration & check-in — an evening of games and good company to kick off the conference." It's now credited as sponsored by MB Precious Metals. (This is on the draft/full Agenda page, which isn't live to visitors yet.)
