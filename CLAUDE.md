...
## Conventions
- Header, footer, floating Join button: identical markup on every page. Conference sub-nav (Overview • Agenda • Speakers • FAQ • Register) appears ONLY on index.html, agenda.html, speakers.html, faq.html.
