...
## Current live state (snapshot — updated September 11, 2026)
...
**Speakers live on `conference-speakers/index.html` (14 active cards, chronological):**
- Thursday: Dr. Harold Katz (TheraBreath), Dr. Daniel Greenbaum (TruAbutment), Dr. Tzvi Krupka, Dr. Ariel Steinberger, Dr. Marc Faber.
- Friday: Dr. Nathaniel Dancykier (2 sessions — Fri 9:00 AM + Shabbos 2:45 PM DVI), Dr. Sara Werb, Dr. Craig Berry, Dr. Sam Glick (orthobrain), Dr. Elaine Bylis, Dr. Ruth Abramowitz (Fri 3:00 PM painting/hand-skills workshop, added Sept 11, 2026), Rabbi Dr. Ephraim Rudolph (Fri 10:30 PM Oneg & Shiur, Crown Catapult).
...
**Dr. Ruth Abramowitz (added Sept 11, 2026) — the 4th Friday-afternoon track.**
- Session: "From Palette to Palate: Painting Your Way to Better Hand Skills," Friday 3:00–5:00 PM, CE 2. Ben confirmed the title on Sept 11 — but her preview page explicitly told her the title was only a suggestion and invited her to rename it, so if she comes back with her own, swap it in BOTH `js/agenda-data.js` and her card in `conference-speakers/index.html` (`data-course` and `.speaker-card__course-title`).
- **Capped at 15 people** (Ben's number, Sept 11). Deliberately NOT shown on the public agenda: none of the other hands-on workshops display a cap, so showing one only on hers would read as an oversight on the others. Spots are handled off the website.
- **Dental Wisdom is buying the supplies, not a sponsor** — her agenda entry has no `sponsor` field, unlike the Glick (orthobrain) and perio (Adin) tracks in the same block. Don't "fix" that.
- Her private preview page is `speaker-review/dr-ruth-abramowitz` (noindex, not linked from anywhere). Rewritten Sept 10–11 from an invitation into a confirmed-speaker note; the bio and card text there and on the live speakers page are the same words and should be changed together.
- **Still unsaid to her anywhere:** the original preview text warned she might be asked to help out briefly at the Welcome Party. That paragraph was cut Sept 11 at Ben's request — worth raising by email closer to the conference so it isn't a surprise on the day.
...
- Friday 3:00–5:00 PM concurrent hands-on block — **4 tracks, 3 filled (updated Sept 11, 2026):** (1) "Straight Forward: Building Your Clear Aligner Practice" — Dr. Sam Glick, sponsored by orthobrain; (2) "From Blob to Beautiful: Cosmetic Dentistry" — Dr. Elaine Bylis; (3) "From Palette to Palate: Painting Your Way to Better Hand Skills" — Dr. Ruth Abramowitz; (4) "Complications in Perio Anterior Cases" — speaker TBD, sponsored by Adin. All four are CE 2 (2-hour block); Ben confirmed 2 credits for Abramowitz on Sept 11, 2026. Photos: images/speaker-elaine-bylis.webp, images/speaker-sam-glick.webp, images/speaker-ruth-abramowitz.webp.
