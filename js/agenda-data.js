...
window.AGENDA_DATA = [
  ...
  { day: "Thursday", time: "10:00 AM – 12:00 PM", title: "Beyond “Savable”: Redefining Restorability Through a Full-Arch Lens – A Modern Approach to Full Mouth Diagnosis and Treatment", speaker: "Dr. Daniel Greenbaum (Prosthodontist)", speakerUrl: "/conference-speakers#speaker-daniel-greenbaum", location: "Shul", ce: true, ceCredits: 2, sponsor: "TruAbutment", sponsorUrl: "/conference-sponsors" },
  ...
  { day: "Friday", time: "12:30 – 1:30 PM", title: "Lunch", speaker: "", location: "OVO at The Altair", event: true },
  ...
  { day: "Friday", time: "3:00 – 5:00 PM", title: "From Blob to Beautiful: Cosmetic Dentistry", speaker: "Dr. Elaine Bylis (Cosmetic Dentist)", speakerUrl: "/conference-speakers#speaker-elaine-bylis", location: "", ce: true, ceCredits: 2, concurrent: "fri-300-breakout" },
  { day: "Friday", time: "3:00 – 5:00 PM", title: "From Palette to Palate: Painting Your Way to Better Hand Skills", speaker: "Dr. Ruth Abramowitz (General Dentist)", speakerUrl: "/conference-speakers#speaker-ruth-abramowitz", location: "", ce: true, ceCredits: 2, concurrent: "fri-300-breakout" },
  // HIDDEN 2026-07-30 (Ben's call — removed the 4th, fully-TBD concurrent track from the Friday 3:00 PM block; restore if a topic/speaker is confirmed): { day: "Friday", time: "3:00 – 5:00 PM", title: "Topic to Be Announced Soon", speaker: "To Be Announced Soon", location: "", ce: true, ceCredits: 2, concurrent: "fri-300-breakout" },
  ...
  { day: "Shabbos", time: "8:15 AM", title: "Pre-Davening Shiur", speaker: "", location: "Library", ce: true, ceCredits: 1 },
  ...
  { day: "Shabbos", time: "11:00 AM", title: "Kiddush & Dvar Torah", speaker: "", location: "Shul", ce: true, ceCredits: 1 },
  ...
  { day: "Shabbos", time: "3:45 PM", title: "Dental Related Shiur to Be Announced Soon", speaker: "", location: "Shul", ce: true, ceCredits: 1 },
