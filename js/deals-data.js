...
window.DEALS_DATA = [
  ...
  },
  {
    ...
    category: "Grow Your Practice",
    description: "A dentist-only growth platform that pairs AI-powered digital marketing with professional website design to help practices attract more ideal patients and grow revenue with less effort.",
    descriptionHtml: "<p>Lasso transforms patient lead flow into effortless revenue. Lasso is a service-based platform that enables simple and repeatable patient growth through marketing services, communication software, and patient analytics. By managing all stages of patient-acquisition, from website-design to ROI-analysis, our suite of services develops a sustainable growth model for your practice.</p><p>The model is simple. Marketing is essential, but it&rsquo;s just Step 1 at Lasso. Our mission is to help your practice adopt a 3-Step process that makes patient growth an integrated part of your day-to-day operation.</p><p><strong>Step 1 - Generate New Patients</strong><br>Create captivating content, activate your online growth channels, and influence your community. Lasso turns your office into a top-tier content producer and enables your content to flourish.</p><p><strong>Step 2 - Master Patient Lead Flow</strong><br>Develop a world-class appointment setting team through the Lasso lead application. Lasso shows your front-desk exactly which new patient leads to contact and what marketing channel the lead came from.</p><p><strong>Step 3 - Become the Practice CEO</strong><br>Make the right decisions with real patient-data, not just website analytics. Lasso&rsquo;s ROI dashboard syncs to your PMS to provide exact revenue numbers on new patients from marketing channels powered by Lasso.</p>",
    link: "https://www.lassomd.com/work-with-us/partners/dental-wisdom",
    promo: "Up to 10% off for Dental Wisdom members",
